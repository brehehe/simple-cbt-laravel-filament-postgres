...
use App\Filament\Resources\Master\AdminResource\Pages;
use App\Filament\Resources\Master\AdminResource\RelationManagers;
...
class AdminResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Data Admin';
    ...
    public static function editUser($record, $data) {
        try {
            ...
            Log::error('Gagal Merubah User: ' . $e->getMessage(), [
                'exception' => $e,
            ]);
